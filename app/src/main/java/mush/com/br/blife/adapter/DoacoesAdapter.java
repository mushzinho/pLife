...
public class DoacoesAdapter extends RecyclerView.Adapter<DoacoesAdapter.myViewHolder> {
    ...
    public void onBindViewHolder(final myViewHolder holder, int position) {
        ...
        holder.dvDoacaoLinha.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {

                selectionModeOn = true;
                holder.dvDoacaoLinha.setBackgroundColor(Color.GRAY);
                ...
                if(!selecionadas.contains(adapterPosition)){
                    ...
                    holder.dvDoacaoLinha.setBackgroundColor(Color.WHITE);
                }
        ...
        holder.dvDoacaoLinha.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class myViewHolder extends  RecyclerView.ViewHolder{
        ...
        private CardView dvDoacaoLinha;
        ...
        myViewHolder(View itemView) {
            ...
            dvDoacaoLinha = (CardView) itemView.findViewById(R.id.cv_doacao_linha);
